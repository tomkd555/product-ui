...
"""
product-ui lookup - BM25 search engine for UI/UX style guides
Usage: python search.py "<query>" [--domain <domain>] [--stack <stack>] [--max-results 3]
       python search.py "<query>" --design-system [-p "Project Name"]
       python search.py "<query>" --design-system --persist [-p "Project Name"] [--page "dashboard"]

Domains: product, style, typography, color, landing, chart, ux, web, icons
...
def format_output(result):
    ...
    output = []
    if result.get("stack"):
        output.append(f"## Stack guidelines")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="product-ui lookup")
